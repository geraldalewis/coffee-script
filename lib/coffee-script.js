(function() {
  ...
  exports.run = function(code, options) {
    ...
    try {
      root._compile(js, root.filename);
    } catch (err) {
      if (options.debug) {
  ...
  debug = function(code, stack, options, ojs) {
    var all, comment, csfile, cslineno, csmsg, errline, errlinenos, file, js, jsline, jslines, jsmsg, lineno, match, msg, ojsline, stackline, _i, _j, _len, _len2, _ref2, _ref3;
    msg = "\n  " + stack[0] + "\n\n";
    printLinenos();
    js = compile(code, options);
    jslines = js.split('\n');
    ...
    _ref2 = stackline.match(/\/([A-Za-z0-9_\ \$\-\_]*\.coffee)\:(\d*)\:\d/), match = _ref2[0], file = _ref2[1], lineno = _ref2[2];
