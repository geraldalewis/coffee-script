...
(function() {
    ...
    Assign.prototype.compilePatternMatch = function(o) {
      ...
      if (top && olen === 1 && !((obj = objects[0]) instanceof Splat)) {
        if (obj instanceof Assign) {
          ...
          if (idx.value === 'this') {
            throw ReferenceError('invalid assignment to "this"');
          }
        } else {
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.compileNode = function(o) {
      var assigns, code, i, id, identifiers, idt, list, lit, name, p, param, references, refs, splats, uniqs, val, variadic, wasEmpty, wrap, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _len6, _m, _n, _o, _ref2, _ref3, _ref4, _ref5, _ref6;
      ...
      for (_n = 0, _len5 = _ref4.length; _n < _len5; _n++) {
        param = _ref4[_n];
        id = param.identifier(o, wrap = true);
        if (!variadic) {
          list.push(id);
        }
        if (param.isComplex()) {
          val = param.value ? new Op('?', id, param.value) : id;
