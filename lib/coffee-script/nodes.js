...
(function() {
  ...
  exports.Literal = Literal = (function(_super) {
    ...
    Literal.prototype.references = function(o) {
      return [this.value];
    };

    Literal.prototype.identifier = function(o) {
      return this.value;
    };
  ...
  exports.Value = Value = (function(_super) {
    ...
    Value.prototype.references = function(o) {
      if (this["this"] != null) {
        return [this.properties[0].name.value];
      }
      return this.base.references(o);
    };

    Value.prototype.identifier = function(o) {
      var value;
      if (this["this"] != null) {
        value = this.properties[0].name.value;
        if (value.reserved && o.generate) {
          return this.generatedId || (this.generatedId = o.scope.freeVariable(value));
        }
        return value;
      }
      return this.base.identifier(o);
    };
  ...
  exports.Obj = Obj = (function(_super) {
    ...
    Obj.prototype.references = function(o) {
      var prop, refs, _i, _len, _ref2;
      refs = [];
      _ref2 = this.properties;
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        prop = _ref2[_i];
        refs.push.apply(refs, prop.references(o));
      }
      return refs;
    };

    Obj.prototype.identifier = function(o) {
      if (!o.generate) {
        return null;
      }
      return this.generatedId || (this.generatedId = o.scope.freeVariable('arg'));
    };
  ...
  exports.Arr = Arr = (function(_super) {
    ...
    Arr.prototype.references = function(o) {
      var obj, refs, _i, _len, _ref2;
      refs = [];
      _ref2 = this.objects;
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        obj = _ref2[_i];
        refs.push.apply(refs, obj.references(o));
      }
      return refs;
    };

    Arr.prototype.identifier = function(o) {
      if (!o.generate) {
        return null;
      }
      return this.generatedId || (this.generatedId = o.scope.freeVariable('arg'));
  ...
  exports.Assign = Assign = (function(_super) {
    ...
    Assign.prototype.lhs = function() {
      return this[this.context === 'object' ? 'value' : 'variable'];
    };

    Assign.prototype.assigns = function(name) {
      return this.lhs().assigns(name);
    };

    Assign.prototype.references = function(o) {
      return this.lhs().references(o);
    };

    Assign.prototype.identifier = function(o) {
      return this.lhs().identifier(o);
    };
    ...
    Assign.prototype.compilePatternMatch = function(o) {
      ...
      if (top && olen === 1 && !((obj = objects[0]) instanceof Splat)) {
        if (obj instanceof Assign) {
          ...
          if (idx.value === 'this') {
            throw new ReferenceError('invalid assignment to "this"');
          }
        } else {
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.compileNode = function(o) {
      var assigns, code, generate, i, id, identifiers, idt, list, lit, name, p, param, ref, references, refs, splats, uniqs, val, variadic, wasEmpty, wrap, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _len6, _m, _n, _o, _ref2, _ref3, _ref4, _ref5, _ref6;
      ...
      list = [];
      assigns = [];
      _ref2 = this.paramIdentifiers(o);
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        id = _ref2[_i];
        o.scope.parameter(id);
      }
      identifiers = this.paramIdentifiers(o, generate = true);
      for (_j = 0, _len1 = identifiers.length; _j < _len1; _j++) {
        id = identifiers[_j];
        o.scope.parameter(id);
      }
      references = this.paramReferences(o);
      uniqs = [];
      ...
      if (variadic) {
        for (_m = 0, _len4 = identifiers.length; _m < _len4; _m++) {
          id = identifiers[_m];
          o.scope.add(id, 'var', true);
        }
        refs = new Arr((function() {
          var _len5, _n, _ref4, _results;
          _ref4 = this.params;
          _results = [];
          for (_n = 0, _len5 = _ref4.length; _n < _len5; _n++) {
            p = _ref4[_n];
            _results.push(p.identifier(o, wrap = true));
          }
          return _results;
        }).call(this));
      ...
      for (_n = 0, _len5 = _ref4.length; _n < _len5; _n++) {
        param = _ref4[_n];
        ref = param.identifier(o, wrap = true);
        if (!splats) {
          list.push(ref);
        }
        if (param.isComplex()) {
          val = param.value ? new Op('?', ref, param.value) : ref;
          assigns.push(new Assign(new Value(param.name), val, '=', {
            param: true
          }));
        } else if (param.value) {
      ...
      if (splats) {
        assigns.unshift(splats);
      }
      if (assigns.length) {
        (_ref5 = this.body.expressions).unshift.apply(_ref5, assigns);
      }
      for (i = _o = 0, _len6 = list.length; _o < _len6; i = ++_o) {
        p = list[i];
        o.scope.parameter(list[i] = p.compile(o));
      }
    ...
    Code.prototype.paramIdentifiers = function(o, generate) {
      var id, ids, param;
      if (generate == null) {
        generate = false;
      }
      ...
      ids = (function() {
        ...
        for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
          param = _ref2[_i];
          if ((id = param.identifier(o)) && (id != null)) {
            _results.push(id);
          }
        }
        return _results;
    ...
    Code.prototype.paramReferences = function(o) {
      var param, ref, refs, _i, _len, _ref2;
      refs = [];
      _ref2 = this.params;
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        param = _ref2[_i];
        refs.push.apply(refs, param.references(o));
      }
      refs = (function() {
        var _j, _len1, _results;
        _results = [];
  ...
  exports.Param = Param = (function(_super) {
    ...
    Param.prototype.references = function(o) {
      var refs;
      refs = (function() {
        try {
          return this.name.references(o);
        } catch (e) {
          throw new ReferenceError("invalid assignment to " + (this.name.compile(o)));
        }
      }).call(this);
      if (this.name.generatedId != null) {
        refs.push(this.name.generatedId);
      }
      return refs;
    };

    Param.prototype.identifier = function(o, wrap) {
      var id, node;
      if (wrap == null) {
        wrap = false;
      }
      id = this.name.identifier(o);
      if (id == null) {
        id = this.name.generatedId;
      }
      if (!wrap) {
        return id;
      }
  ...
  exports.Splat = Splat = (function(_super) {
    ...
    Splat.prototype.references = function(o) {
      return this.name.references(o);
    };

    Splat.prototype.identifier = function(o) {
      return this.name.identifier(o);
    };
