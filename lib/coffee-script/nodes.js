(function() {
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.compileNode = function(o) {
      var allNames, code, exprs, i, idt, lit, p, param, paramNames, params, pname, ref, splats, uniqs, val, wasEmpty, _i, _j, _k, _l, _len, _len2, _len3, _len4, _len5, _len6, _len7, _m, _n, _o, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      ...
      for (_k = 0, _len3 = _ref5.length; _k < _len3; _k++) {
        param = _ref5[_k];
        _ref6 = allNames = param.simpleNames();
        for (_l = 0, _len4 = _ref6.length; _l < _len4; _l++) {
          pname = _ref6[_l];
          if (!o.scope.check(pname)) o.scope.parameter(pname);
        }
      ...
      for (_m = 0, _len5 = _ref7.length; _m < _len5; _m++) {
        ...
        if (param.isComplex()) {
          ...
          if (param.refName != null) paramNames.push(param.refName);
      ...
      for (i = _n = 0, _len6 = params.length; _n < _len6; i = ++_n) {
        p = params[i];
        o.scope.parameter(params[i] = p.compile(o));
      }
      uniqs = [];
      for (_o = 0, _len7 = paramNames.length; _o < _len7; _o++) {
        pname = paramNames[_o];
        if (__indexOf.call(uniqs, pname) >= 0) {
  ...
  exports.Param = Param = (function(_super) {
    ...
    function Param(name, value, splat) {
      ...
      this.value = value;
      this.splat = splat;
      if (_ref3 = this.name.unwrapAll().value, __indexOf.call(STRICT_PROSCRIBED, _ref3) >= 0) {
    ...
    Param.prototype.simpleNames = function(node) {
      var names, obj, _i, _len, _ref3;
      if (node == null) node = this.name;
      names = [];
      if (!node.objects) {
        if (node["this"] && node.properties[0].name.value.reserved) return [];
        if (node["this"]) return [node.properties[0].name.value];
        return [node.value];
      }
      _ref3 = node.objects;
      for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
        ...
        if (obj instanceof Value) {
          if (obj["this"] && obj.properties[0].name.value.reserved) continue;
