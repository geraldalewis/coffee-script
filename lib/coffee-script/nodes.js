...
(function() {
  ...
  exports.Value = Value = (function(_super) {
    ...
    Value.prototype.references = function(o, generateIdentifier) {
      var value;
      ...
      if (this["this"] != null) {
        ...
        if (value.reserved && generateIdentifier) {
  ...
  exports.Obj = Obj = (function(_super) {
    ...
    Obj.prototype.references = function(o, generateIdentifier) {
      ...
      if (generateIdentifier) {
        refs.unshift(this.generatedId || (this.generatedId = o.scope.freeVariable('arg')));
      }
      return refs;
    };
  ...
  exports.Arr = Arr = (function(_super) {
    ...
    Arr.prototype.references = function(o, generateIdentifier) {
  ...
  exports.Assign = Assign = (function(_super) {
    ...
    Assign.prototype.reference = function() {
      return this[this.context === 'object' ? 'value' : 'variable'];
    };

    Assign.prototype.assigns = function(name) {
      return this.reference().assigns(name);
    };

    Assign.prototype.references = function(o) {
      return this.reference().references(o);
    };
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.compileNode = function(o) {
      var assigns, code, i, id, identifiers, idt, list, lit, name, p, param, ref, references, refs, splats, uniqs, val, variadic, wasEmpty, wrap, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _len6, _m, _n, _o, _ref2, _ref3, _ref4, _ref5, _ref6;
      ...
      identifiers = this.paramIdentifiers(o);
    ...
    Code.prototype.paramIdentifiers = function(o) {
      var generate, id, ids, param, wrap;
      ids = (function() {
        var _i, _len, _ref2, _results;
        _ref2 = this.params;
        _results = [];
        for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
          param = _ref2[_i];
          if (id = param.identifier(o, wrap = false, generate = false)) {
            _results.push(id);
          }
        }
        return _results;
  ...
  exports.Param = Param = (function(_super) {
    ...
    Param.prototype.references = function(o, generateIdentifiers) {
      var refs;
      ...
      refs = (function() {
        try {
          return this.name.references(o, generateIdentifiers);
        } catch (e) {
    ...
    Param.prototype.identifier = function(o, wrap, generateIdentifiers) {
      var id, node;
      if (wrap == null) {
        wrap = false;
      }
      ...
      id = this.references(o, generateIdentifiers)[0];
      if (!wrap) {
        return id;
      }
      node = new Literal(id);
